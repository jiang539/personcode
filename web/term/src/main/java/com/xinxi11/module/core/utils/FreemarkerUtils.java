package com.xinxi11.module.core.utils;
...
public class FreemarkerUtils {
	...
	public static void execute(File ftlFile, String distFilePath, Map<String, Object> data)
			throws TemplateException, IOException {
		File packageFile = new File(distFilePath).getParentFile();
		if (!packageFile.exists()) {
			boolean createResult = packageFile.mkdirs();
			if (!createResult) {
				log.error("创建文件失败!");
				return;
			}
	...
	public static String execute(File ftlFile, Map<String, Object> data) throws TemplateException,
			IOException {
	...
	public static Template createTemplate(File ftlFile) throws IOException {
		...
		// 获取指定模板文件
		return cfg.getTemplate(ftlFile.getName());
	}
